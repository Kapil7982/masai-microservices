...
export class AuthenticationMiddleware {
    ...
    public static isAuthenticated(
        ...
        if (req.headers['access_token']=="" && req.headers['refresh_token']==""&& req.headers["id_token"]==""||
        req.headers['access_token']==undefined && req.headers['refresh_token']==undefined && req.headers["id_token"]==undefined) {
